...
using OrchestrationTaskConfig = AzureOpsCrew.Infrastructure.Db.EntityTypes.OrchestrationTaskEntityTypeConfiguration;
...
public class AzureOpsCrewContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new OrchestrationTaskConfig());
    }
}
