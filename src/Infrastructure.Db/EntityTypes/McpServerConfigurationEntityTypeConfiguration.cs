    ...
    public void Configure(EntityTypeBuilder<McpServerConfiguration> builder)
    {
        ...
        builder.OwnsOne(x => x.Auth, authBuilder =>
        {
            ...
            authBuilder.Property(x => x.BearerToken)
                ...
                .HasMaxLength(4000);
            authBuilder.OwnsMany(x => x.Headers, headersBuilder =>
            {
                headersBuilder.ToTable("McpServerConfigurationAuthHeaders");
                headersBuilder.WithOwner()
                    .HasForeignKey("McpServerConfigurationId");
                headersBuilder.Property<int>("Id")
                    .ValueGeneratedOnAdd();
                headersBuilder.HasKey("Id");
                headersBuilder.Property(x => x.Name)
                    .IsRequired()
                    .HasMaxLength(200);
                headersBuilder.Property(x => x.Value)
                    .IsRequired()
                    .HasMaxLength(4000);
            });
        });
