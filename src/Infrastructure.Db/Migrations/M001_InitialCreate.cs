...
public class M001_InitialCreate : Migration
{
    public override void Up()
    {
        Create.Table("Agent")
            ...
            .WithColumn("ProviderId").AsGuid().NotNullable().WithDefaultValue(new Guid("00000000-0000-0000-0000-000000000000"))
        ...
        IfDatabase("Postgres")
            .Execute.Sql(@"ALTER TABLE ""Agent"" ALTER COLUMN ""Id"" TYPE uuid USING ""Id""::uuid;
