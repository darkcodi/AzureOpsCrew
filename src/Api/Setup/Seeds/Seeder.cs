    ...
    public class Seeder
    {
        ...
        public async Task Seed()
        {
            ...
            var provider = new Provider(providerId,
                ...
                selectedModels: "[\"deepseek-chat\"]", defaultModel: "deepseek-chat");
        ...
        {
            var existing = await _context.Set<Channel>()
            ...
            {
                // Update ManagerAgentId on existing channel if it changed
                if (existing.ManagerAgentId != channel.ManagerAgentId)
                    existing.ManagerAgentId = channel.ManagerAgentId;
            }
        }
