...
/** Stub data shown when the widget is invoked with no args (e.g. showDeployment tool). */
const STUB_ENVIRONMENTS: DeploymentEnv[] = [
  { name: "Development", status: "succeeded", version: "1.2.3", lastDeployed: "2 hours ago" },
  { name: "Staging", status: "in progress", version: "1.2.4", lastDeployed: "Deploying..." },
  { name: "Production", status: "pending", version: "1.2.2", lastDeployed: "1 day ago" },
]
...
export function DeploymentCard({
  ...
  const applicationName = applicationNameProp ?? "Application"
  const environments =
    environmentsProp && environmentsProp.length > 0 ? environmentsProp : STUB_ENVIRONMENTS
