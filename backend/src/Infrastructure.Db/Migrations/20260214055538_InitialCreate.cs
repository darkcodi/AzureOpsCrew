    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                ...
                "'gpt-5-2-chat', 'Helps with planning, priorities, resource allocation, team coordination, and delivery', '[]', 'Local0', '#43b581', datetime('now'))");
            ...
            migrationBuilder.Sql(
                ...
                "'gpt-5-2-chat', 'Expert in Azure DevOps pipelines, CI/CD, repos, boards, artifacts, and release management', '[]', 'Local0', '#0078d4', datetime('now'))");
            ...
            migrationBuilder.Sql(
                ...
                "'gpt-5-2-chat', 'Expert in building and deploying apps on Azure: App Service, Functions, Container Apps, AKS, and more', '[]', 'Local0', '#00bcf2', datetime('now'))");
